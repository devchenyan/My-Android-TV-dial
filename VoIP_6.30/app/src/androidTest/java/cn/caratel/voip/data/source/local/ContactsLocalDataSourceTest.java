...
public class ContactsLocalDataSourceTest {
    ...
    public void saveContact_retrievesContact() {
        final Contact contact = new Contact(VOIP_NUMBER, PHONE_NUMBER, "", "");
    ...
    public void getContacts_retrieveSavedContacts() {
        final Contact contact1 = new Contact(VOIP_NUMBER, PHONE_NUMBER, "", "");
        localDataSource.save(contact1);
        final Contact contact2 = new Contact(VOIP_NUMBER2, PHONE_NUMBER2, "", "");
